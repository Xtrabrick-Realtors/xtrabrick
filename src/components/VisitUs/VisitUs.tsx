  ...
  return (
    <AnimatedContainer id="visitUs" style={animation} ref={ref}>
      ...
      <ContentWrapper>
        <a
          target={"_blank"}
          href="http://maps.google.com/?q=Office No. 45, Vision One Mall, Bhumkar Chowk, Wakad - 411033, Pune, Maharashtra, India"
        >
          ...
          >
            *Click on the image to open the location on google maps
          </p>
        </a>
